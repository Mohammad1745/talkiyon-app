...
const STATUS_PENDING_FOR_APPROVAL = 7;
const STATUS_APPROVED_BY_ADMIN = 8;
const STATUS_SERVED = 9;
const STATUS_DRAFT = 10;
const STATUS_EXPIRED = 11;
const STATUS_INCOMPLETE = 12;
const STATUS_COMPLETE = 13;
const STATUS_NOT_STARTED = 14;
const STATUS_INTERVIEWING = 15;
const STATUS_HIRED = 16;
